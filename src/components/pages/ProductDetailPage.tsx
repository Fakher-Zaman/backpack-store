  ...
  if (!product) {
    return (
      <div className="flex min-h-[60vh] flex-col items-center justify-center gap-4 px-6 pt-24">
        ...
        <Link
          to="/"
          className="text-sm text-brand-green-dark underline hover:text-brand-green"
        >
          Back to home
        </Link>
      </div>
  ...
  return (
    <div className="mx-auto max-w-7xl px-6 pb-20 pt-28">
      ...
      <nav className="mb-8 text-sm text-gray-500" aria-label="Breadcrumb">
        <Link to="/" className="hover:text-brand-green-dark">Home</Link>
        <span className="mx-2">/</span>
        <Link to="/#products" className="hover:text-brand-green-dark">Products</Link>
        <span className="mx-2">/</span>
      ...
      <div className="grid gap-12 lg:grid-cols-2">
        ...
        <div className="flex flex-col gap-6">
          {product.category && (
            <span className="w-fit rounded-full bg-brand-green-dark/10 px-3 py-1 text-xs font-medium text-brand-green-dark">
              {product.category}
            </span>
          )}
