...
- `src/components/` — UI organized by feature: `banners/`, `blog/`, `collections/`, `hero/`, `layout/`, `products/`, `features/`, `ui/`
...
- `src/styles/index.css` — Tailwind entry point (`@tailwind base/components/utilities`)
...
All images use Unsplash URLs with sizing params (e.g., `?w=600&h=400&fit=crop`). No local image assets.
